...
[role="_abstract"]
Reference the available Performance Profile Creator arguments to configure CPU allocation, kernel settings, and power management options for your performance profiles.
