...
----
+
<1> In a disconnected environment make sure to configure resolution of this image by either:

* creating a `ImageTagMirrorSet` custom resource (CR) 
  
  or

* setting the URL pointing to the disconnected registry
