...
This procedure configures a T-GM (Telecom Grandmaster) clock on {sno} (SNO) that uses an Intel E810 Westport Channel NIC as the PTP grandmaster clock with GNSS to NTP failover capabilities.
