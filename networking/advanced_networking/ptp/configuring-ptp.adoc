...
include::modules/nw-ptp-gnrd-standards-compliance-reference.adoc[leveloffset=+3]
...
* xref:../../../networking/advanced_networking/ptp/configuring-ptp.adoc#nw-ptp-gnrd-standards-compliance-reference_configuring-ptp[ITU-T standards compliance for Intel Granite Rapids-D Telecom Grandmaster]
...
include::modules/ptp-configuring-linuxptp-services-dual-port-bc.adoc[leveloffset=+2]

include::modules/ptp-verifying-dual-port-bc-failover.adoc[leveloffset=+2]

include::modules/ptp-dual-port-bc-parameters-reference.adoc[leveloffset=+2]
